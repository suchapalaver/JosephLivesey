...
Before the company was forced to lay off all of its US employees in August 2023 I was a backend software engineer at Blockchain Technology Partners (BTP) working on [Chronicle](https://github.com/btpworks/chronicle/), an open-source, blockchain-backed, platform for recording [provenance information](https://www.w3.org/TR/prov-o/) written in Rust. Since October I've continued to work in Rust on the backend and with AWS at [BALANCED Media|Technology](https://www.balancedmediatechnology.com/) ([github.com/balanced-livc](https://github.com/balanced-livc/)).
